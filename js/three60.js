...
The method recieves a delta object that specify how much panning should be applied
and then it rotates the textured sphere accordingly
...
(function(context) {
	...
	// create and initialize the camera, by positioning it, specifying a lookAt direction and setting its FOV
	...
	// the method responsible for rendering the output of the player + it calls the stat update method
	...
	// initializes the 3D scene: creates & positions the textured sphere and the camera
	...
	// At the end calls the callback parameter, to notify the intializer of the completion of the process
	...
	// public method, that sets the options for the module and initializes video loading.
	// on load complete it commences the initialization of the rest of the necesarry items
	...
	// declares the methods that are accesible to the public context
	context.three60 = {
